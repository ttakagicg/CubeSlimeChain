...
#if UNITY_5_0 || UNITY_5_1 || UNITY_5_2 || UNITY_5_3 || UNITY_5_4 || UNITY_5_5 || UNITY_5_6 || UNITY_5_7 || UNITY_2017
			if (_terrain.materialType == Terrain.MaterialType.BuiltInStandard) {
			
				_terrainMaterial = new Material(Shader.Find("Fast Shadow Projector/FSP_Standard-TerrainFirstPass"));
				_standardTerrain = true;
			} else {
				_terrainMaterial = new Material(Shader.Find("Fast Shadow Projector/FSP_TerrainFirstPass"));
